...
namespace our {
    ...
    public:
        ...
        Texture2D() {
            ...
            //Syntax: glGenTextures(GLsizei n,GLuint * textures);
        ...
        ~Texture2D() { 
            //TODO: (Req 5) Complete this function
            //Syntax:glDeleteTextures(	GLsizei n,const GLuint * textures);
        ...
        void bind() const {
            //TODO: (Req 5) Complete this function
            //Syntax: glBindTexture(GLenum target,GLuint texture);
